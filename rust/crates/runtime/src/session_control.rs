...
pub struct SessionStore {
    ...
    /// `/home/user/project/.ruoyi/sessions/a1b2c3d4e5f60718/`.
...
impl SessionStore {
    ...
    ///
    /// The on-disk layout becomes `<cwd>/.ruoyi/sessions/<workspace_hash>/`.
...
pub fn managed_sessions_dir_for(
    ...
    let path = base_dir.as_ref().join(".ruoyi").join("sessions");
